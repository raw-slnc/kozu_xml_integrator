...
class KozuXmlIntegrator:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'KozuXmlIntegrator_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&Kozu XML Integrator/公図XML整合ツール')
    ...
    def unload(self):
        ...
        # Clean up main window (clear highlights, restore tools)
        ...
        for action in self.actions:
            self.iface.removePluginVectorMenu(
                self.tr(u'&Kozu XML Integrator/公図XML整合ツール'),
                action)
